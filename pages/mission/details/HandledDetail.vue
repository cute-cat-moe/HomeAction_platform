        ...
        <el-col :span="12">
          <div class="header">
            <el-breadcrumb separator=">>">
              <el-breadcrumb-item :to="{ path: '/mission/handled' }">任务中心</el-breadcrumb-item>
              <el-breadcrumb-item :to="{ path: '/mission/handled' }">已完成任务</el-breadcrumb-item>
          ...
          <el-row>
            <el-card class="card-msg">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-row><span class="detailDesCSS">任务结束时间</span></el-row>
                  <el-row><span class="detailValueCSS">{{ task.end_time | date('YYYY-MM-DD HH:mm') }} 小时</span></el-row>
                </el-col>
                <el-col :span="8">
                  <el-row><span class="detailDesCSS">搜寻时间</span></el-row>
                  <el-row><span class="detailValueCSS">{{ (task.end_time - task.start_time) | date('HH') }} 小时 {{ (task.end_time - task.start_time) | date('MM') }} 分钟</span></el-row>
                </el-col>
              </el-row>
              <el-divider/>
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-row><span class="detailDesCSS">是否找到</span></el-row>
                  <el-row><span class="detailValueCSS"><finded-tag :finded="task.finded"></finded-tag></span></el-row>
                </el-col>
              </el-row>
              <el-divider v-if="task.finded"/>

              <el-row v-if="task.finded">
                <el-col :span="24">
                  <el-card>
                    <div slot="header">
                      <el-row>
                        <el-col :span="8"><span class="detailDesCSS">老人找到地点：</span></el-col>
                        <el-col :span="16"><span class="detailValueCSS">{{ task.find_area }}</span></el-col>
                      </el-row>
                    </div>
                    <div>
                      <div id="amap"></div>
...
import FindedTag from '@/components/mission/FindedTag.vue'
...
export default defineComponent ({
  ...
  setup(props, ctx) {
    ...
    ctx.root.$http.get(`admin/task_center/task_finish/${param}`)
      .then(res => {
